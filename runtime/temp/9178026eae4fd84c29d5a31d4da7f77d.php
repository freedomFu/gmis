<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"C:\wamp64\www\gmis\public/../application/home\view\Main\userSet.html";i:1545228108;s:59:"C:\wamp64\www\gmis\application\home\view\Public\header.html";i:1544787648;s:59:"C:\wamp64\www\gmis\application\home\view\Public\footer.html";i:1543467483;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row">
        ...
        <div class="layui-col-md8">
            <div style="width:700px;margin:50px auto;">
                <h2 id="setTeacherInfo">教师信息管理</h2>
                <form class="layui-form " id="set_info_form" action="#" style="padding: 15px 20px 0 0;" method="post">
                    ...
                    <div class="layui-form-item set_info">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="starttimer" value="<?php echo $teainfo['starttimer']; ?>" id="starttimer" lay-verify="date|belongtime|checkrank" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <!--中期时间-->
                    <div class="layui-form-item set_info">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="middletimer" value="<?php echo $teainfo['middletimer']; ?>" id="middletimer" lay-verify="date|belongtime|checkrank" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <!--答辩时间-->
                    <div class="layui-form-item set_info">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="replytimer" value="<?php echo $teainfo['replytimer']; ?>" id="replytimer" lay-verify="date|belongtime|checkrank" placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <!--答辩地点-->
                    <div class="layui-form-item set_info">
