<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"C:\wamp64\www\gmis\public/../application/admin\view\teacher\add.html";i:1543289551;s:61:"C:\wamp64\www\gmis\application\admin\view\layout\default.html";i:1540985180;s:58:"C:\wamp64\www\gmis\application\admin\view\common\meta.html";i:1540985180;s:60:"C:\wamp64\www\gmis\application\admin\view\common\script.html";i:1540985180;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-teapwd" data-rule="required" disabled class="form-control" name="row[teapwd]" type="text" value="c9adc24f05976055d8f7eeb679d721d9">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-teaphone" data-rule="required" class="form-control" name="row[teaphone]" type="text" value="尚未填写">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-replyplace" data-rule="required" class="form-control" name="row[replyplace]" type="text" value="尚未填写">
        </div>
    </div>
    <div class="form-group">
