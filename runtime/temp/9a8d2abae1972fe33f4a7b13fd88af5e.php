<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"C:\wamp64\www\gmis\public/../application/admin\view\adjust\auto.html";i:1545360680;s:61:"C:\wamp64\www\gmis\application\admin\view\layout\default.html";i:1540985180;s:58:"C:\wamp64\www\gmis\application\admin\view\common\meta.html";i:1540985180;s:60:"C:\wamp64\www\gmis\application\admin\view\common\script.html";i:1540985180;}*/ ?>
<!DOCTYPE html>
...
<div class="panel panel-default panel-intro" id="adjust_panel">
    <div class="panel-body">
        <div id="myTabContent" class="tab-content">
            <p id="adjust_title"><span>自动调剂</span></p>
            <div class="adjust_btn">
                <button class="layui-btn layui-btn-lg layui-btn-warm layui-btn-radius" id="prior_adjust">优先调剂</button>
            </div>
            <div class="adjust_btn">
                <button class="layui-btn layui-btn-lg layui-btn-primary layui-btn-radius" id="default_adjust">默认调剂</button>
            </div>
        </div>
    </div>
</div>
