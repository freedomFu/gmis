<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"C:\wamp64\www\gmis\public/../application/home\view\Tapply\showSelectStu.html";i:1543653335;s:59:"C:\wamp64\www\gmis\application\home\view\Public\header.html";i:1543553675;s:59:"C:\wamp64\www\gmis\application\home\view\Public\footer.html";i:1543467483;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-body">
    <div class="layui-container">
        <!-- 内容主体区域 -->
        <h2 id="userCon" style="text-align: center;padding: 15px 0">管理学生申请</h2>

        <table id="selectStu" lay-filter="selectStu"></table>
        <script type="text/html" id="operation-bar">
            <a class="layui-btn layui-btn-danger layui-btn-xs " lay-event="allow">同意</a>
        </script>

        <script type="text/html" id="isSubmitTpl">
            {{(d.issubmit==='1'?'是':'否')}}
        </script>
    </div>
</div>
...
<script src="http://127.0.0.1/gmis/public/fhome/js/showSelectStu.js"></script>