<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"C:\wamp64\www\gmis\public/../application/admin\view\tapply\add.html";i:1542810354;s:61:"C:\wamp64\www\gmis\application\admin\view\layout\default.html";i:1540985180;s:58:"C:\wamp64\www\gmis\application\admin\view\common\meta.html";i:1540985180;s:60:"C:\wamp64\www\gmis\application\admin\view\common\script.html";i:1540985180;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-nature" data-rule="required" class="form-control" name="row[nature]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group hidden">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-isnew" data-rule="required" class="form-control" name="row[isnew]" type="text" value="0">
        </div>
    </div>
    <div class="form-group hidden">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Isprac'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-isprac" data-rule="required" class="form-control" name="row[isprac]" type="text" value="0">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Proid'); ?>:（1代表计科，2代表软件，3代表网络，4代表信安）</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-proid" data-rule="required" class="form-control" name="row[proid]" type="number" value="1">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group hidden">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-stuid" class="form-control" name="row[stuid]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Belongsenior'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-belongsenior" data-rule="required" class="form-control" name="row[belongsenior]" type="text" value="2018-2019">
        </div>
    </div>
    <div class="form-group hidden">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Teaid'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-teaid" class="form-control" name="row[teaid]" type="number">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[status]-<?php echo $key; ?>"><input id="row[status]-<?php echo $key; ?>" name="row[status]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"未通过"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
