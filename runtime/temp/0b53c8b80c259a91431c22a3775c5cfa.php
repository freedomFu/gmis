<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"C:\wamp64\www\gmis./application/common\view\tpl\dispatch_jump.tpl";i:1543194737;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="shortcut icon" href="/gmis/assets/img/favicon.ico" />
    <style type="text/css">
...
<div class="system-message <?php echo $codeText; ?>">
    <div class="image">
        <img src="/gmis/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
    </div>
    <h1><?php echo $msg; ?></h1>
    <?php if($url): ?>
        <p class="jump">
